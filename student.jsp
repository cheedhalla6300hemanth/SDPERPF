...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="student-info">
            <img src="images/studenticon.png" alt="Student Profile Picture">
    ...
    <div class="sidebar">
        <ul class="navbar-nav">
            ...
            <li><a class="nav-link" href="#">View Courses</a></li>
            <li><a class="nav-link" href="#">View Attendance</a></li>
            <li><a class="nav-link" href="#">View Timetable</a></li>
    ...
    <div class="content">
        ...
        <p>Welcome to the ERP System's Student Panel. Use the sidebar to navigate through your modules.</p>
