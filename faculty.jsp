...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="faculty-info">
            <img src="images/facultyicon.png" alt="Faculty Profile Picture">
    ...
    <div class="content">
        ...
        <p>Welcome to your ERP Faculty Panel. Use the sidebar to manage your subjects, attendance, and more.</p>
        <button class="btn btn-custom">Manage Attendance</button>
    </div>
